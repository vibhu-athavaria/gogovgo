    ...
    render() {
        ...
        return (
            <Modal {...this.props} aria-labelledby="contained-modal-title-lg">
                ...
                <Modal.Body>
                    <div className="texto_modales margin_abajo_tobig">
                        ...
                        <Col xs={12}>
                            ...
                            <ListGroup>
                                <ListGroupItem>
                                    ...
                                    carefully before using the DonaldTrumpReviews.com website (the
                                    "Service") operated by DonaldTrumpReviews ("us", "we", or
                                    ...
                                    you may not access the Service. This Terms of Service is
                                    licensed by TermsFeed Generator to DonaldTrumpReviews.
                                </ListGroupItem>
                                <ListGroupItem header="Links To Other Web Sites">
                                    Our Service may contain links to third-party web sites or
                                    services that are not owned or controlled by DonaldTrumpReviews.
                                    DonaldTrumpReviews has no control over, and assumes no
                                    responsibility for, the content, privacy policies, or practices
                                    of any third party web sites or services. You further
                                    acknowledge and agree that DonaldTrumpReviews shall not be
                                    ...
                                    on or through any such web sites or services. We strongly advise
                                ...
                                <ListGroupItem header="Contact Us">
                                    ...
                                    <a href="mailto:contactGoGovGo@gmail.com">contact us</a>.
                                </ListGroupItem>
                            </ListGroup>
                        </Col>
                    </Row>
