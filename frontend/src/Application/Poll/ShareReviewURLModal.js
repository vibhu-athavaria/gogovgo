            ...
            <div className="texto_modales_center">
                <div className="text-center">
                    ...
                    <div className="your-review-has-been">
                        Your review has been published. Use the link below to access your review and
                        share with friends. The most upvoted reviews earn authors special access to
                ...
                <div className="form-group text-center m0">
                    <button type="button" className="btn btn-modal btn-primary" onClick={onClose}>
                        Continue
                    </button>
                </div>
            </div>
